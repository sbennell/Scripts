...
$form.Size = New-Object System.Drawing.Size(750, 665)
...
$mainPanel.Size = New-Object System.Drawing.Size(715, 240)
...
$comboSite.Items.AddRange(@("SJW", "MT", "Custom"))
...
$comboType.Items.AddRange(@("STU", "STF", "SHARE"))
...
$checkAssignUser = New-Object System.Windows.Forms.CheckBox
$checkAssignUser.Location = New-Object System.Drawing.Point(20, 145)
$checkAssignUser.Size = New-Object System.Drawing.Size(120, 20)
$checkAssignUser.Text = "Assign User:"
...
$textAssignedUser.Enabled = $false
...
$lblAssignedComputerName.Size = New-Object System.Drawing.Size(150, 20)
$lblAssignedComputerName.Text = "Assigned Computer Name:"

$textAssignedComputerName = New-Object System.Windows.Forms.TextBox
$textAssignedComputerName.Location = New-Object System.Drawing.Point(180, 173)
$textAssignedComputerName.Size = New-Object System.Drawing.Size(270, 20)
...
$lblComputerNameHelp.Size = New-Object System.Drawing.Size(100, 20)
...
$mainPanel.Controls.AddRange(@(
    ...
    $checkAssignUser, $textAssignedUser, $lblUserHelp,
...
$txtOutput.Size = New-Object System.Drawing.Size(700, 280)
...
$btnGetInfo.Location = New-Object System.Drawing.Point(20, 590)
...
$btnClear.Location = New-Object System.Drawing.Point(160, 590)
$btnClear.Size = New-Object System.Drawing.Size(80, 30)
$btnClear.Text = "Clear"

$btnExit = New-Object System.Windows.Forms.Button
$btnExit.Location = New-Object System.Drawing.Point(640, 590)
...
# Function to update email domain based on site
function Update-EmailDomain {
    # Only update if the checkbox is checked
    if ($checkAssignUser.Checked) {
        $currentText = $textAssignedUser.Text
        
        # Only update if the field is empty or contains just a domain
        if ($currentText -eq "" -or $currentText.StartsWith("@")) {
            switch ($comboSite.SelectedItem) {
                "SJW" {
                    $textAssignedUser.Text = "@sjwreservoirnth.catholic.edu.au"
                }
                "MT" {
                    $textAssignedUser.Text = "@motherteresa.catholic.edu.au"
                }
                "Custom" {
                    $textAssignedUser.Text = ""
                }
            }
        }
    }
...
# Function to check if user assignment should be enabled
function Update-UserAssignmentAvailability {
    if ($comboType.SelectedItem -eq "SHARE") {
        # Disable user assignment for shared devices
        $checkAssignUser.Checked = $false
        $checkAssignUser.Enabled = $false
        $textAssignedUser.Enabled = $false
        $textAssignedUser.Text = ""
    } else {
        # Enable user assignment for personal devices
        $checkAssignUser.Enabled = $true
    }
}
...
$comboType.Add_SelectedIndexChanged({
    Update-GroupTag
    Update-UserAssignmentAvailability
})
...
# Assign User checkbox change event
$checkAssignUser.Add_CheckedChanged({
    $textAssignedUser.Enabled = $checkAssignUser.Checked
    if ($checkAssignUser.Checked) {
        Update-EmailDomain
    } else {
        $textAssignedUser.Text = ""
...
$btnGetInfo.Add_Click({
    ...
    try {
        ...
        if ($checkAssignUser.Checked -and $textAssignedUser.Text.Trim() -ne "") {
...
# Initialize the group tag and check user assignment availability
Update-GroupTag
Update-UserAssignmentAvailability
