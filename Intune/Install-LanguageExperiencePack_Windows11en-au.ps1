...
$geoId = "12"  # Australia
# Define the minimum Windows 11 version
$windows11Version = New-Object System.Version "10.0.22000.0"
...
# Compare the OS version with Windows 11 version
if ($osVersion -ge $windows11Version) {
    # Copy User Internaltional Settings from current user to System, including Welcome screen and new user
	"Copy UserInternationalSettingsToSystem "
	Copy-UserInternationalSettingsToSystem -WelcomeScreen $True -NewUser $True
} else {
    Write-Output "This is not Windows 11 skiping."
}
