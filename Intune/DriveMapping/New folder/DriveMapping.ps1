...
.DESCRIPTION
	...
	Updated to remove VBScript dependency due to Microsoft's VBScript deprecation.

.NOTES
	Author: Nicola Suter, nicolonsky tech: https://tech.nicolonsky.ch
	Modified: VBScript removed and replaced with PowerShell native -WindowStyle Hidden
#>
...
# UPDATED: VBScript dependency removed - using PowerShell native -WindowStyle Hidden
###########################################################################################
...
if (Test-RunningAsSystem) {
	...
	Write-Output "VBScript dependency removed - using PowerShell native hiding"
	...
	###########################################################################################
	# NO VBScript needed - using PowerShell native -WindowStyle Hidden
	###########################################################################################

	Write-Output "VBScript wrapper not needed - using PowerShell native hiding"

	###########################################################################################
	# Register a scheduled task to run for all users and execute the script on logon
	# UPDATED: Direct PowerShell execution with -WindowStyle Hidden
	###########################################################################################

	$schtaskName = "IntuneDriveMapping"
	$schtaskDescription = "Map network drives from intune-drive-mapping-generator. Updated to remove VBScript dependency."
	...
	# UPDATED: Use PowerShell native hiding instead of VBScript wrapper
	...
	Write-Output "Creating scheduled task with PowerShell native hiding..."
	Write-Output "Task Name: $schtaskName"
	Write-Output "Script Path: $scriptPath"
	Write-Output "Action: powershell.exe -WindowStyle Hidden -NoProfile -ExecutionPolicy Bypass -File `"$scriptPath`""
...
###########################################################################################
# Done - VBScript dependency removed
###########################################################################################